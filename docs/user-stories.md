...
- **US-04** _(Fase futura)_ Como ciudadano, quiero recuperar mi contraseña si la olvido.

### Reservas
- **US-05** Como ciudadano, quiero ver qué pistas de pádel existen para saber qué puedo reservar.
- **US-06** Como ciudadano, quiero ver la disponibilidad semanal de una pista para elegir fecha y hora.
- **US-07** Como ciudadano, quiero reservar un slot disponible en una pista para asegurar mi turno.
...
- **US-17** _(Fase futura)_ Como admin, quiero crear una reserva manualmente para cualquier usuario registrado.
...
### Gestión de pistas
- **US-27** Como admin, quiero crear nuevas pistas de pádel para ampliar la oferta del complejo.
- **US-28** Como admin, quiero editar los datos de una pista (nombre, descripción, horario) para mantenerlos actualizados.
- **US-29** Como admin, quiero desactivar una pista sin eliminarla para que no aparezca disponible temporalmente.

### Dashboard y métricas
- **US-30** Como admin, quiero ver en el dashboard las métricas del día (reservas hoy, reservas activas, pistas activas, cancelaciones) para tener una visión rápida del estado del complejo.
